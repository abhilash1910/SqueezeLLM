...
void vecquant3matmul_nuq_perchannel_sycl(
  torch::Tensor vec, torch::Tensor mat, torch::Tensor mul,
  torch::Tensor lookup_table
);
void vecquant4matmul_nuq_perchannel_sycl(
  torch::Tensor vec, torch::Tensor mat, torch::Tensor mul,
  torch::Tensor lookup_table
);
void vecquant3matmul_nuq_perchannel_batched_sycl(
  torch::Tensor vec, torch::Tensor mat, torch::Tensor mul,
  torch::Tensor lookup_table
);
void vecquant4matmul_nuq_perchannel_batched_sycl(
  torch::Tensor vec, torch::Tensor mat, torch::Tensor mul,
  torch::Tensor lookup_table
);

void vecquant3matmul_spmv_nuq_perchannel_sycl(
  torch::Tensor rows,
  torch::Tensor cols,
  torch::Tensor mat,
  torch::Tensor vec,
...
void vecquant4matmul_spmv_nuq_perchannel_sycl(
  torch::Tensor rows,
  torch::Tensor cols,
  torch::Tensor mat,
  torch::Tensor vec,
...
void vecquant3matmul_spmv_nuq_perchannel_batched_sycl(
  torch::Tensor rows,
  torch::Tensor cols,
  torch::Tensor mat,
  torch::Tensor vec,
...
void vecquant4matmul_spmv_nuq_perchannel_batched_sycl(
  torch::Tensor rows,
  torch::Tensor cols,
  torch::Tensor mat,
  torch::Tensor vec,
...
void vecquant3matmul_spmv_hybrid_nuq_perchannel_sycl(
  torch::Tensor rows,
  torch::Tensor cols,
  torch::Tensor mat,
  torch::Tensor vec,
...
void vecquant4matmul_spmv_hybrid_nuq_perchannel_sycl(
  torch::Tensor rows,
  torch::Tensor cols,
  torch::Tensor mat,
  torch::Tensor vec,
...
void vecquant3matmul_spmv_hybrid_nuq_perchannel_batched_sycl(
  torch::Tensor rows,
  torch::Tensor cols,
  torch::Tensor mat,
  torch::Tensor vec,
...
void vecquant4matmul_spmv_hybrid_nuq_perchannel_batched_sycl(
  torch::Tensor rows,
  torch::Tensor cols,
  torch::Tensor mat,
  torch::Tensor vec,
...
void vecquant3matmul_nuq_perchannel(
  ...
  vecquant3matmul_nuq_perchannel_sycl(vec, mat, mul, lookup_table);
}
void vecquant4matmul_nuq_perchannel(
  torch::Tensor vec, torch::Tensor mat, torch::Tensor mul,
  torch::Tensor lookup_table
) {
  vecquant4matmul_nuq_perchannel_sycl(vec, mat, mul, lookup_table);
}
void vecquant3matmul_nuq_perchannel_batched(
  torch::Tensor vec, torch::Tensor mat, torch::Tensor mul,
  torch::Tensor lookup_table
) {
  vecquant3matmul_nuq_perchannel_batched_sycl(vec, mat, mul, lookup_table);
}
void vecquant4matmul_nuq_perchannel_batched(
  torch::Tensor vec, torch::Tensor mat, torch::Tensor mul,
  torch::Tensor lookup_table
) {
  vecquant4matmul_nuq_perchannel_batched_sycl(vec, mat, mul, lookup_table);
}
...
void vecquant3matmul_spmv_nuq_perchannel(
  ...
  vecquant3matmul_spmv_nuq_perchannel_sycl(rows, cols, mat, vec, mul, num_rows, mat3, lookup_table);
}
void vecquant4matmul_spmv_nuq_perchannel(
  ...
  vecquant4matmul_spmv_nuq_perchannel_sycl(rows, cols, mat, vec, mul, num_rows, mat4, lookup_table);
}
...
void vecquant3matmul_spmv_nuq_perchannel_batched(
  ...
  vecquant3matmul_spmv_nuq_perchannel_batched_sycl(rows, cols, mat, vec, mul, num_rows, mat3, lookup_table);
}
void vecquant4matmul_spmv_nuq_perchannel_batched(
  ...
  vecquant4matmul_spmv_nuq_perchannel_batched_sycl(rows, cols, mat, vec, mul, num_rows, mat4, lookup_table);
}
...
void vecquant3matmul_spmv_hybrid_nuq_perchannel(
  ...
  vecquant3matmul_spmv_hybrid_nuq_perchannel_sycl(rows, cols, mat, vec, full_rows, full_row_indices, mul, num_rows, mat3, lookup_table);
}
void vecquant4matmul_spmv_hybrid_nuq_perchannel(
  ...
  vecquant4matmul_spmv_hybrid_nuq_perchannel_sycl(rows, cols, mat, vec, full_rows, full_row_indices, mul, num_rows, mat4, lookup_table);
}
...
void vecquant3matmul_spmv_hybrid_nuq_perchannel_batched(
  ...
  vecquant3matmul_spmv_hybrid_nuq_perchannel_batched_sycl(rows, cols, mat, vec, full_rows, full_row_indices, mul, num_rows, mat3, lookup_table);
}
void vecquant4matmul_spmv_hybrid_nuq_perchannel_batched(
  ...
  vecquant4matmul_spmv_hybrid_nuq_perchannel_batched_sycl(rows, cols, mat, vec, full_rows, full_row_indices, mul, num_rows, mat4, lookup_table);
}
